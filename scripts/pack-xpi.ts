// Package dist/firefox into the canonical release artifact the shared
// release-extension workflow collects: dist-artifacts/<base>-firefox-<tag>.xpi
...
const OUT = resolve(OUTDIR, `${base}-firefox-${tag}.xpi`);
